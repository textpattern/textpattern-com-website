...
!https://travis-ci.org/textpattern/textpattern-com-website.svg?branch=master!:https://travis-ci.org/textpattern/textpattern-com-website !https://david-dm.org/philwareham/hive-framework/dev-status.svg(devDependency Status)!:https://david-dm.org/textpattern/textpattern-com-website#info=devDependencies !https://cdn.gruntjs.com/builtwith.png(Built with Grunt)!:http://gruntjs.com/
